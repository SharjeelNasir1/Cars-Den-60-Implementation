import "./MyLeasedAdsItems.css";
import React from "react";
import { Link } from "react-router-dom";

const MyLeasedAdsItems = ({ add, onDel }) => {
  return (
    <div className="video-item item">
      <Link to={`/myleasedadsdetails/${add._id}`}>
        <div>
...
export default MyLeasedAdsItems;
